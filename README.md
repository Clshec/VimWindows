...
> - **ضغطة 1**: 🟢 **NORMAL MODE** (شارة خضراء كبيرة - ملاحة Vimium وتمرير وتلميحات).  
> - **ضغطة 2**: 🔵 **MOUSE MODE** (شارة زرقاء كبيرة - تحريك ماوس فوري فائق السرعة).  
> - **ضغطة 3**: ⚫ **INSERT MODE** (وضع الكتابة العادي في ويندوز).  
> - **زر `Esc`**: يخرج فوراً من أي وضع إلى وضع الكتابة العادي `INSERT MODE`.

### 1. محرك الماوس الخارق (MOUSE MODE - الحالة 2 🔵)

عند الضغط على **`Home`** للمرة الثانية (أو ضغط `m` في NORMAL MODE)، يتم تفعيل وضع الماوس المستقل:

| الاختصار داخل وضع الماوس | الوظيفة | الوصف |
| :--- | :--- | :--- |
| **`h/j/k/l`** أو **الأسهم** أو **`WASD`** أو **`UIOP`** | 🖱️ **تحريك الماوس بسرعة 10x** | تحريك ناعم وفوري وتسارع فيزيائي عالي جداً. |
| **`Space`** أو **`Enter`** | 👈 **نقر أيسر** | Left Click مباشر في مكان المؤشر الحالي. |
| **`Shift + Space`** أو **`Shift + Enter`** | 👉 **نقر أيمن** | Right Click لفتح القائمة السياقية (Context Menu). |
| **`Ctrl + Space`** | 🔘 **نقر أوسط** | Middle Click لفتح الروابط في تبويب جديد. |
...
| **`g`** | 🔢 **شبكة القفز 3x3** | إظهار شبكة القفز الفوري للشاشة (1 إلى 9). |
| **`Esc`** أو **`Home`** | ↩️ **خروج من وضع الماوس** | الخروج الفوري لوضع الكتابة أو الدورة التالية. |
