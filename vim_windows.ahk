...
global ScrollSpeed     := 3     ; السرعة من 1 إلى 10 (الافتراضي 3)
...
GetScrollDelta(spd) {
    ...
    ; قيم الإزاحة الميكروية بعد قسمتها على 2 للحصول على انزلاق فائق التأني والهدوء
    ; السرعة 1: 0.25 ديلتا (حركة فائقة البطء والهدوء للقراءة المركزة جداً)
    ; السرعة 3: 0.75 ديلتا (السرعة الافتراضية المريحة للقراءة الهادئة)
    ; السرعة 10: 10.5 ديلتا
    deltas := [0.25, 0.5, 0.75, 1.25, 2.0, 2.75, 4.0, 5.5, 7.75, 10.5]
    return deltas[spd]
}
