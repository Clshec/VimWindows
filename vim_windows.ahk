...
GetScrollDelta(spd) {
    ...
    ; قيم الإزاحة الميكروية بعد قسمتها على 2 مرة أخرى
    ; السرعة 1: 0.5 ديلتا (انزلاق فائق البطء والهدوء عبر المجمع البكسلي)
    ; السرعة 3: 1.5 ديلتا (السرعة الافتراضية)
    ; السرعة 10: 21.0 ديلتا
    deltas := [0.5, 1.0, 1.5, 2.5, 4.0, 5.5, 8.0, 11.0, 15.5, 21.0]
    return deltas[spd]
}
